        ...
        <div className={styles.container}>
            <form onSubmit={submitHandler} className={styles.formContainer}>
                ...
                <div className={styles.formField}>
                    <label>Name :</label>
                    <input className={(errors.name && touched.name) ? styles.uncopleted : styles.formInput}
                     type="text" name="name" value={data.name} onChange = {changeHandler} onFocus = {focusHandler}/>
                    {errors.name && touched.name &&<span>{errors.name}</span>}
                </div>
                <div className={styles.formField}>
                    <label>email :</label>
                    <input className={(errors.email && touched.email) ? styles.uncopleted : styles.formInput}
                     type="text" name="email" value={data.email} onChange = {changeHandler} onFocus = {focusHandler}/>
                    {errors.email && touched.email &&<span>{errors.email}</span>}
                </div>
                <div className={styles.formField}>
                    <label>password :</label>
                    <input className={(errors.password && touched.password) ? styles.uncopleted : styles.formInput}
                     type="password" name="password" value={data.password} onChange = {changeHandler} onFocus = {focusHandler}/>
                    {errors.password && touched.password &&<span>{errors.password}</span>}
                </div>
                <div className={styles.formField}>
                    <label>confirmPassword :</label>
                    <input className={(errors.confirmPassword && touched.confirmPassword) ? styles.uncopleted : styles.formInput}
                ...
                <div className={styles.formField}>
                    ...
                    <input className={(errors.isAccepted && touched.isAccepted) ? styles.uncopleted : styles.formInput}
